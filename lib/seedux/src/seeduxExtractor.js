...
/**
*
* Turns an array that consists of the name and the propNames of the container passed into uiExtractor,
...
const reducersExtractor = (reducers) => {
