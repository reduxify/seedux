...
seedux.uiExtractor = (ui) => {
let uiName, uiPropNames, uiChildPropNames;
...
seedux.reducersExtractor = (reducers) => {
...
seedux.actionCreatorsExtractor = (actionCreators) => {
