...
/**
* Calls the next dispatch method in the middleware chain, attaches undo and redo event listeners to the application, and dispatches a custom event object containing aggregate information of the application's state.
*
