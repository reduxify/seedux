...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxifyLogger = __webpack_require__(182);

	var _reduxifyLogger2 = _interopRequireDefault(_reduxifyLogger);
	...
	var aShim = _reduxifyLogger2.default;
	bundledAPIs.dispatchLogger = aShim;
	console.log(bundledAPIs);

	exports.bundledAPIs = bundledAPIs;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (/******/function (modules) {
			...
			/***/function (module, exports, __webpack_require__) {
				...
				/* WEBPACK VAR INJECTION */(function (process) {
					...
					var _applyMiddleware = __webpack_require__(8);
	   ...
	   */
				...
				var D3UIStructurer = function D3UIStructurer(parsedUI) {
					var headNode = new Node('Containers');
					headNode.children = [];
					parsedUI.forEach(function (container) {
						var containerNode = new Node(container.name);
						containerNode.children = [];
						headNode.children.push(containerNode);
						container.propNames.forEach(function (p) {
							return containerNode.children.push(new Node(p));
						});
					});
					return headNode;
				};
	   ...
	   */
				...
				var D3ReducersStructurer = function D3ReducersStructurer(parsedReducers) {
					var headNode = new Node('Reducers');
					headNode.children = [];
					parsedReducers.forEach(function (reducer) {
						var reducerNode = new Node(reducer.name);
						reducerNode.children = [];
						headNode.children.push(reducerNode);
						reducer.cases.forEach(function (c) {
							return reducerNode.children.push(new Node(c));
						});
					});
					return headNode;
				};
	   ...
	   */
				...
				var D3ActionCreatorStructurer = function D3ActionCreatorStructurer(parsedActionCreators) {
					var headNode = new Node('Action Creators');
					headNode.children = [];
					parsedActionCreators.forEach(function (actionCreator) {
						var actionCreatorNode = new Node(actionCreator.name);
	    ...
	    */
				...
				reduxify.UIExtractor = function (UI) {
					var UIObj = {};
					var UIName = UI[0];
	    ...
	    */
				...
				reduxify.ReducerExtractor = function (reducers) {
					var reducersObj = {};
					var structuredReducersArr = [];
					var reducerNames = Object.keys(reducers);
					reducerNames.forEach(function (reducer) {
						return reducersObj[reducer] = [];
					});
					reducers = JSON.stringify(reducers);
					var reducersArr = reducers.split('switch');
					var reducerCases = reducersArr.map(function (cases) {
						return cases.match(/case\s[\\'"\w]*:/gi, '');
					}).join('').replace(/case|break|return/g, '').replace(/['";,\s]/g, '').split(':');
					...
					reducerNames.forEach(function (key) {
	    ...
	    */
				...
				reduxify.ActionExtractor = function (actionCreators) {
					console.log('Extracting Actions...');
					var actionCreatorsObj = {};
					var structuredActionCreatorsArr = [];
					var actionCreatorsNames = Object.keys(actionCreators);
					actionCreators = JSON.stringify(actionCreators);
					var actionCreatorsArr = actionCreators.split('type:');
					var actionTypes = actionCreatorsArr.map(function (t) {
						return t.match(/['"]\w*['",]/gi);
					}, '').slice(1);
					...
					actionCreatorsNames.forEach(function (key) {
	    ...
	    */
				...
				module.exports = { reduxify: reduxify };
	    ...
	    */
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var _reduxifyExtractor = __webpack_require__(4);
	    ...
	    */
				function bindActionCreators(actionCreators, dispatch) {
					...
					_reduxifyExtractor.reduxify.ActionExtractor(reduxifyObj);
	     ...
	     */
					function combineReducers(reducers) {
						...
						_reduxifyExtractor.reduxify.ReducerExtractor(reduxifyObj);
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var _Symbol3 = __webpack_require__(5),
	    ...
	    */
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var _Symbol4 = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if (( false ? 'undefined' : _typeof(exports)) === 'object' && ( false ? 'undefined' : _typeof(module)) === 'object') module.exports = factory(__webpack_require__(5), __webpack_require__(162));else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(5), __webpack_require__(162)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object') exports["ReactRedux"] = factory(require("react"), require("redux"));else root["ReactRedux"] = factory(root["React"], root["Redux"]);
	})(undefined, function (__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_21__) {
		return (/******/function (modules) {
				// webpackBootstrap
				/******/ // The module cache
				/******/var installedModules = {};
	    ...
	    */
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var _reduxifyExtractor = __webpack_require__(9);
				...
				function connect(mapStateToProps, mapDispatchToProps, mergeProps) {
					...
					return function wrapWithConnect(WrappedComponent) {
						...
						_reduxifyExtractor.reduxify.UIExtractor([UI, props]);
	   ...
	   */
	    ...
	    */
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var _Symbol3 = __webpack_require__(4);
